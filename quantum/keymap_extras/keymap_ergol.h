...
#define EL_CIRC ALGR(EL_Q)    // ^
#define EL_LABK ALGR(EL_C)    // <
#define EL_RABK ALGR(EL_O)    // >
#define EL_DLR  ALGR(EL_P)    // $
#define EL_PERC ALGR(EL_W)    // %
#define EL_AT   ALGR(EL_J)    // @
#define EL_AMPR ALGR(EL_M)    // &
#define EL_ASTR ALGR(EL_D)    // *
#define EL_QUOT ALGR(EL_1DK)  // '
#define EL_GRV  ALGR(EL_Y)    // `
#define EL_LCBR ALGR(EL_A)    // {
#define EL_LPRN ALGR(EL_S)    // (
#define EL_RPRN ALGR(EL_E)    // )
#define EL_RCBR ALGR(EL_N)    // }
#define EL_EQL  ALGR(EL_F)    // =
#define EL_BSLS ALGR(EL_L)    // (backslash)
#define EL_PLUS ALGR(EL_R)    // +
#define EL_MINS ALGR(EL_T)    // -
#define EL_SLSH ALGR(EL_I)    // /
#define EL_DQUO ALGR(EL_U)    // "
#define EL_TILD ALGR(EL_Z)    // ~
#define EL_LBRC ALGR(EL_X)    // [
#define EL_RBRC ALGR(EL_MINS) // ]
#define EL_UNDS ALGR(EL_V)    // _
#define EL_HASH ALGR(EL_B)    // #
#define EL_PIPE ALGR(EL_DOT)  // |
#define EL_EXLM ALGR(EL_H)    // !
#define EL_SCLN ALGR(EL_G)    // ;
#define EL_COLN ALGR(EL_COMM) // :
#define EL_QUES ALGR(EL_K)    // ?
...
#define BP_MACR S(ALGR(EL_T))    // ¯ (dead)
